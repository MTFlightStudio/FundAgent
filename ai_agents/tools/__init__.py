...
from .classification import classify_email_tool, EmailClassification
...
__all__ = [
    ...
    "classify_email_tool",          # Expose the new tool
    "EmailClassification"           # Expose Pydantic model
]
...
if __name__ == '__main__':
    ...
    print(f"classify_email_tool available: {callable(classify_email_tool)}")
